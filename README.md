...
For non-programmers, head over to the [TITAN Discord](https://titansoftwork.com/) & download the precompiled binary (This comes with source), to add it to startup run ``Windows + R`` & type ``shell:startup``, then drag ``TASX.exe`` in there.
